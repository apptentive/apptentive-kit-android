...
internal object ThrottleUtils {
    ...
    fun shouldThrottleResetConversation(): Boolean {
        ...
        val sdkVersion: String = sharedPrefDataStore.getString(SharedPrefConstants.CORE_DATA, SharedPrefConstants.SDK_VERSION)
        ...
        return if (sdkVersion.isEmpty() || sdkVersion != apptentiveSDKVersion) {
            ...
            sharedPrefDataStore.putString(SharedPrefConstants.CORE_DATA, SharedPrefConstants.SDK_VERSION, Constants.SDK_VERSION)
            false
        } else {
