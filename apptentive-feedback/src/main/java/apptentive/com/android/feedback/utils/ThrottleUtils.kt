...
internal object ThrottleUtils {
    ...
    fun shouldThrottleResetConversation(): Boolean {
        ...
        val sdkVersion: String = sharedPrefDataStore.getString(SharedPrefConstants.THROTTLE_UTILS, SharedPrefConstants.CONVERSATION_RESET_THROTTLE)
        ...
        return if (sdkVersion.isEmpty() || sdkVersion != apptentiveSDKVersion) {
            ...
            sharedPrefDataStore.putString(SharedPrefConstants.THROTTLE_UTILS, SharedPrefConstants.CONVERSATION_RESET_THROTTLE, Constants.SDK_VERSION)
            false
        } else {
