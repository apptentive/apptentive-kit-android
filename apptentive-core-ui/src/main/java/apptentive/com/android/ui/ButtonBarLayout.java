 ...
 *
 * Note: this is an exact copy from appcompat library.
 * The ONLY difference - this implementation does not reverse view order when stacked.
 */
public class ButtonBarLayout extends LinearLayout {
    ...
    private void setStacked(boolean stacked) {
        ...
        /*
        NOTE: We deliberately disallow child view order reverse here
