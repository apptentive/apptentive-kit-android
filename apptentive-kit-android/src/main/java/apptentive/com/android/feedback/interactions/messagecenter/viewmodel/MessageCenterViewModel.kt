...
internal class MessageCenterViewModel(
    ...
    fun buildMessageViewDataModel(): List<MessageViewData> {
        ...
        messageViewData.add(
            0,
            MessageViewData(
                ListItemType.HEADER, GreetingData(greeting, greetingBody, getAvatar()), null, null
        ...
        messageViewData.add(
            MessageViewData(
                ListItemType.FOOTER, null,
                ProfileViewData(getEmailHint(), getNameHint(), shouldCollectProfileData), null
            )
        )
