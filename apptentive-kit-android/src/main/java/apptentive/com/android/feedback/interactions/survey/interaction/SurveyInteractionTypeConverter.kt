package apptentive.com.android.feedback.interactions.survey.interaction
...
internal class SurveyInteractionTypeConverter : InteractionTypeConverter<SurveyInteraction> {
    ...
    private fun Map<String, Any?>.convertTermsAndConditions(): SurveyInteraction.TermsAndConditions {
        return SurveyInteraction.TermsAndConditions(
