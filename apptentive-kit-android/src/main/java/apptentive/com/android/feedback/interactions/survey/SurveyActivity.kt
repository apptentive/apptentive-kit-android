...
import apptentive.com.android.feedback.interactions.survey.viewmodel.SurveyIntroductionPageItem
import apptentive.com.android.feedback.interactions.survey.viewmodel.SurveyListItem.Type
import apptentive.com.android.feedback.interactions.survey.viewmodel.SurveySuccessPageItem
import apptentive.com.android.feedback.interactions.survey.viewmodel.register
...
internal class SurveyActivity : BaseSurveyActivity() {
    ...
    private fun createListAdapter() = ListViewAdapter().apply {
        ...
        register(
            ...
            factory = SurveyQuestionViewHolderFactory(
