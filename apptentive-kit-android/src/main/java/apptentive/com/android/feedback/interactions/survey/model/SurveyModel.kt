...
import apptentive.com.android.feedback.interactions.survey.model.SurveyPageData.PageIndicatorStatus
import apptentive.com.android.feedback.interactions.survey.utils.END_OF_QUESTION_SET
import apptentive.com.android.feedback.interactions.survey.utils.UNSET_QUESTION_SET
...
internal class SurveyModel(
    ...
    lateinit var currentPageID: String
    private val singlePageID: String = "single"
    val introPageID: String = "intro"
