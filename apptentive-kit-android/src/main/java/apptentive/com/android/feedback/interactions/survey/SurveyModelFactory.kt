...
import apptentive.com.android.feedback.interactions.survey.interaction.DefaultSurveyQuestionSetConverter
...
internal class DefaultSurveyModelFactory(
    ...
    override fun getSurveyModel(): SurveyModel {
        return SurveyModel(
            ...
            requiredText = interaction.requiredText ?: engagementContext.getAppActivity().getString(
                R.string.apptentive_required
            ),
