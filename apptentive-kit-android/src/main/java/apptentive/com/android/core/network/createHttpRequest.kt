 ...
 */
internal class HttpJsonResponseReader<T>(private val type: Class<T>) : HttpResponseReader<T> {
    override fun read(
...
internal class HttpByteArrayResponseReader : HttpResponseReader<ByteArray> {
