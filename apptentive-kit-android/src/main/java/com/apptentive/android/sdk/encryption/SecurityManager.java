    ...
    public static @NonNull Encryption getEncryption(Context context, @Nullable Encryption encryption, boolean shouldEncryptStorage) throws EncryptionInitializationException {
		...
		if (encryption != null) {
			if (!hasEncryptionInfo(context)) {
				...
				return com.apptentive.android.sdk.encryption.EncryptionFactory.wrapNullSafe(encryption);
			}
		...
		com.apptentive.android.sdk.encryption.EncryptionKey masterKey = resolveMasterKey(context, keyInfo);
