 ...
 * See: <a href="https://github.com/apptentive/apptentive-android/blob/master/apptentive/src/main/java/com/apptentive/android/sdk/conversation/Conversation.java">...</a>
 */
...
class LegacyConversation {
	 ...
	 */
	private com.apptentive.android.sdk.conversation.ConversationData conversationData;
	 ...
	 */
	private com.apptentive.android.sdk.conversation.ConversationState state = com.apptentive.android.sdk.conversation.ConversationState.UNDEFINED;
	...
	public LegacyConversation(File conversationDataFile, File conversationMessagesFile, @NonNull Encryption encryption, @Nullable String payloadEncryptionKey) {
		...
		conversationData = new com.apptentive.android.sdk.conversation.ConversationData();
	}
    ...
    void loadConversationData() throws SerializerException {
		...
		conversationData = (com.apptentive.android.sdk.conversation.ConversationData) serializer.deserialize();
	...
	public com.apptentive.android.sdk.conversation.ConversationState getState() {
		return state;
	}

	public void setState(com.apptentive.android.sdk.conversation.ConversationState state) {
		this.state = state;
	}
