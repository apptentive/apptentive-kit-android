 ...
 * See: <a href="https://github.com/apptentive/apptentive-android/blob/master/apptentive/src/main/java/com/apptentive/android/sdk/conversation/ConversationMetadataItem.java">...</a>
 */
public class LegacyConversationMetadataItem implements SerializableObject {
	 ...
	 */
	private com.apptentive.android.sdk.conversation.ConversationState conversationState = com.apptentive.android.sdk.conversation.ConversationState.UNDEFINED;
	...
	public LegacyConversationMetadataItem(DataInput in) throws IOException {
		...
		conversationState = com.apptentive.android.sdk.conversation.ConversationState.valueOf(in.readByte());
	...
	public LegacyConversationMetadataItem(@Nullable String conversationId, @Nullable String conversationToken, File dataFile, @Nullable String conversationEncryptionKey, @Nullable String userId) {
		...
		this.conversationState = com.apptentive.android.sdk.conversation.ConversationState.LOGGED_IN;
	...
	public com.apptentive.android.sdk.conversation.ConversationState getConversationState() {
