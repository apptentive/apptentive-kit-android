...
public class DefaultLegacyConversationManager implements LegacyConversationManager {
	...
	@Override
	public @Nullable com.apptentive.android.sdk.conversation.ConversationData loadLegacyConversationData(com.apptentive.android.sdk.conversation.LegacyConversationMetadata conversationMetadata) {
		try {
	...
	@Nullable
	@Override
	public com.apptentive.android.sdk.conversation.LegacyConversationMetadata loadLegacyConversationMetadata() {
		try {
			Log.v(MIGRATION, "Resolving metadata...");
			com.apptentive.android.sdk.conversation.LegacyConversationMetadata conversationMetadata = resolveMetadata();
		...
		return new com.apptentive.android.sdk.conversation.LegacyConversationMetadata();
	}
	...
	private @Nullable
	LegacyConversation loadActiveConversationGuarded(com.apptentive.android.sdk.conversation.LegacyConversationMetadata conversationMetadata) throws ConversationLoadException {
	 ...
	 */
	private @Nullable
	LegacyConversation loadConversationFromMetadata(com.apptentive.android.sdk.conversation.LegacyConversationMetadata metadata) throws SerializerException, ConversationLoadException {
	...
	private com.apptentive.android.sdk.conversation.LegacyConversationMetadata resolveMetadata() throws com.apptentive.android.sdk.conversation.ConversationMetadataLoadException {
		try {
			...
			if (metaFile.exists()) {
				...
				com.apptentive.android.sdk.conversation.LegacyConversationMetadata metadata = ObjectSerialization.deserialize(metaFile, com.apptentive.android.sdk.conversation.LegacyConversationMetadata.class, encryption);
			...
			if (metaFile.exists()) {
				...
				com.apptentive.android.sdk.conversation.LegacyConversationMetadata metadata = ObjectSerialization.deserialize(metaFile, com.apptentive.android.sdk.conversation.LegacyConversationMetadata.class);
			...
			throw new com.apptentive.android.sdk.conversation.ConversationMetadataLoadException("Unable to load metadata", e);
		}
